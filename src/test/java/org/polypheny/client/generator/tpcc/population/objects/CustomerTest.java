...
public class CustomerTest {
    ...
    private void verifyCustomer( Customer customer, District district, final Timestamp C_SINCE ) {
        ...
        TPCCPopulationGeneratorTest.checkStringLength( customer.getC_FIRST(), 8, 16 );
        TPCCPopulationGeneratorTest.checkStringLength( customer.getC_STREET_1(), 10, 20 );
        TPCCPopulationGeneratorTest.checkStringLength( customer.getC_STREET_2(), 10, 20 );
        TPCCPopulationGeneratorTest.checkStringLength( customer.getC_CITY(), 10, 20 );
        TPCCPopulationGeneratorTest.checkStringLength( customer.getC_STATE(), 2, 2 );
        TPCCPopulationGeneratorTest.verifyZip( customer.getC_ZIP() );
        ...
        TPCCPopulationGeneratorTest.checkStringLength( customer.getC_DATA(), 300, 500 );
    }
}
