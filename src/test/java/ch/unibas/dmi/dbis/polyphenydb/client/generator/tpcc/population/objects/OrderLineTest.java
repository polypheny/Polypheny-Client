...
import static ch.unibas.dmi.dbis.polyphenydb.client.generator.tpcc.population.TPCCPopulationGeneratorTest.generateOrder;
...
public class OrderLineTest {
    ...
    private void verifyOrderLine( Order order, OrderLine orderLine, int MAX_OL_NUMBER ) {
        ...
        checkStringLength( orderLine.getOL_DIST_INFO(), 24, 24 );
    }
}
