...
public class PartGenerator
    ...
    public PartGenerator( double scaleFactor, int part, int partCount, Distributions distributions,
            TextPool textPool ) {
    ...
    private static class PartGeneratorIterator
        ...
        private PartGeneratorIterator( Distributions distributions, TextPool textPool, long startIndex,
                long rowCount ) {
