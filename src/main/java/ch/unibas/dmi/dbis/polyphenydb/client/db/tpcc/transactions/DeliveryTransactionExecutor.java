...
public abstract class DeliveryTransactionExecutor extends TransactionExecutor {
    ...
    public TPCCResultTuple deliveryTransaction( final int queryID, final int W_ID ) {
        ...
        try {
            ...
            return TPCCResultTuple( start, (stop - start), TPCCTransactionType.TPCCTRANSACTIONDELIVERY, queryID, false, queries );
        } catch ( TransactionAbortedException e ) {
            logger.debug( "Aborted transaction" );
            return TPCCResultTuple( start, 0, TPCCTransactionType.TPCCTRANSACTIONDELIVERY, queryID, true, queries );
        }
    }
