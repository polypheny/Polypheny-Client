...
import static ch.unibas.dmi.dbis.polyphenydb.client.rpc.ProtoObjectFactory.TPCHResultTuple;

import ch.unibas.dmi.dbis.polyphenydb.client.config.TPCHConfig;
...
import ch.unibas.dmi.dbis.polyphenydb.client.db.access.JDBCPostgresConnector;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.CustomerGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.LineItemGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.NationGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.OrderGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.PartGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.PartSupplierGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.RegionGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.TPCHPopulationGenerators.SupplierGenerator;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.Customer;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.GenerateUtils;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.LineItem;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.Nation;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.Order;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.Part;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.PartSupplier;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.Region;
import ch.unibas.dmi.dbis.polyphenydb.client.generator.tpch.objects.Supplier;
...
public class PostgresTpchBenchmarker extends TPCHBenchmarker {
    ...
    public TPCHResultTuple genericRefreshFunctionExecutor( int refreshFunctionID ) {
        try {
            ...
            return TPCHResultTuple( start, (stop - start), transactionType, refreshFunctionID, false, query.toString() );
        } catch ( ConnectionException e ) {
