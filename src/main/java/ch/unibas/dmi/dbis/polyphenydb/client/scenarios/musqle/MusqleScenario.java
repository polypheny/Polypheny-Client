package ch.unibas.dmi.dbis.polyphenydb.client.scenarios.musqle;


import static ch.unibas.dmi.dbis.polyphenydb.client.rpc.ProtoObjectFactory.MusqleWorkerMessage;
import static ch.unibas.dmi.dbis.polyphenydb.client.rpc.ProtoObjectFactory.StopWorkerMessage;
import static ch.unibas.dmi.dbis.polyphenydb.client.rpc.ProtoObjectFactory.createFetchMusqleMessage;

import ch.unibas.dmi.dbis.polyphenydb.client.analysis.musqle.MusqleAnalysis;
...
public class MusqleScenario implements Scenario {
    ...
    private void fetchResults( long start, long stop ) {
        ...
        for ( WorkerStub workerStub : workers ) {
            ...
            workerStub.writeMusqleResults( this.resultWriter, createFetchMusqleMessage( start, stop ) );
        }
    ...
    private void launchWorkers() {
        ...
        for ( String workerURL : workerURLs ) {
            ...
            LaunchWorkerMessage workerMessage = MusqleWorkerMessage(
    ...
    public void abort() {
        ...
        for ( WorkerStub worker : workers ) {
            worker.stopWorker( StopWorkerMessage( PolyClientGRPC.Scenario.SCENARIOMUSQLE ) );
        }
    }
