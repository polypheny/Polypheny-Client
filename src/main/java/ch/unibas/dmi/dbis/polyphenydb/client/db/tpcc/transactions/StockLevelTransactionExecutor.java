...
public abstract class StockLevelTransactionExecutor extends TransactionExecutor {
    ...
    public TPCCResultTuple stockLevelTransaction( final int W_ID, final int queryID, final int D_ID ) {
        ...
        try {
            ...
            return TPCCResultTuple( start, (stop - start), TPCCTransactionType.TPCCTRANSACTIONSTOCK, queryID, false, queries );
        } catch ( TransactionAbortedException e ) {
            logger.debug( "Transaction Aborted" );
            return TPCCResultTuple( start, 0, TPCCTransactionType.TPCCTRANSACTIONSTOCK, queryID, true, queries );
        }
    }
