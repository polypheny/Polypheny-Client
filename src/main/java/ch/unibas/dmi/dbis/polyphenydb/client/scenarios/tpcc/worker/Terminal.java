...
import ch.unibas.dmi.dbis.polyphenydb.client.grpc.PolyClientGRPC.TPCCResultMessage.Builder;
...
import ch.unibas.dmi.dbis.polyphenydb.client.grpc.PolyClientGRPC.TPCCWorkerMessage.ThinkModeCase;
...
public class Terminal implements Runnable {
    ...
    public Terminal( TPCCWorker worker, int districtID, int warehouseID ) {
        ...
        File storageFolder = new File( new File( DEFAULT_WORKER_STORAGE_LOCATION ), warehouseID + "" );
