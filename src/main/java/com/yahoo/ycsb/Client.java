/**
 * Copyright (c) 2010-2016 Yahoo! Inc., 2017 YCSB contributors All rights reserved. <p> Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at <p>
...
class StatusThread extends Thread {
    ...
    private long computeStats( final long startTimeMs, long startIntervalMs, long endIntervalMs,
        ...
        StringBuilder msg = new StringBuilder( labelString ).append( " " ).append( interval / 1000 )
                .append( " sec: " );
...
public final class Client {
    ...
    public static void usageMessage() {
        ...
        System.out
                .println( "  " + WORKLOAD_PROPERTY + ": the name of the workload class to use (e.g. " +
    ...
    private static void exportMeasurements( Properties props, int opcount, long runtime )
        ...
        try {
            ...
            exporter
                    .write( "TOTAL_GC_TIME_%", "Time(%)", ((double) totalGCTime / runtime) * (double) 100 );
    ...
    /**
     * Current abstraction point for our workers.
     *
     * @param props Properties as received by the master.
     */
    public static void executeWithProperties( Properties props ) {

        boolean status = Boolean
                .valueOf( props.getProperty( STATUS_PROPERTY, String.valueOf( false ) ) );
    ...
    private static List<ClientThread> initDb( String dbname, Properties props, int threadcount,
        ...
        boolean dotransactions = Boolean
                .valueOf( props.getProperty( DO_TRANSACTIONS_PROPERTY, String.valueOf( true ) ) );
        ...
        try ( final TraceScope span = tracer.newScope( CLIENT_INIT_SPAN ) ) {
            ...
            if ( dotransactions ) {
                ...
                if ( props.containsKey( INSERT_COUNT_PROPERTY ) ) {
                    ...
                    opcount = Integer
                            .parseInt( props.getProperty( RECORD_COUNT_PROPERTY, DEFAULT_RECORD_COUNT ) );
                }
            }
    ...
    private static HTraceConfiguration getHTraceConfiguration( Properties props ) {
        ...
        for ( String key : props.stringPropertyNames() ) {
            if ( key.startsWith( HTRACE_KEY_PREFIX ) ) {
                filteredProperties
                        .put( key.substring( HTRACE_KEY_PREFIX.length() ), props.getProperty( key ) );
            }
        }
