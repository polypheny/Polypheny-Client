/**
 * Copyright (c) 2016-2017 YCSB contributors. All rights reserved. <p> Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at <p> http://www.apache.org/licenses/LICENSE-2.0 <p> Unless
...
public class IncrementingPrintableStringGenerator extends Generator<String> {
     ...
     *
     * @param length The length of string to return from the generator.
     * @param characterSet A set of code points to choose from. Code points in the set can be in any order, not necessarily lexical.
     * @throws IllegalArgumentException if the length is less than one or the character set has fewer than one code points.
     */
     ...
     * @param characterTypesFilter An optional set of allowable character types. See {@link Character} for types.
     * @param isFilterAllowableList Determines whether the {@code allowableTypes} set is inclusive or exclusive. When true, only those code points that appear in the list will be included in the resulting set. Otherwise matching code points are excluded.
     * @param allowableTypes An optional list of code points for inclusion or exclusion.
     * @return A list of code points matching the given range and filters. The list may be empty but is guaranteed not to be null.
     */
