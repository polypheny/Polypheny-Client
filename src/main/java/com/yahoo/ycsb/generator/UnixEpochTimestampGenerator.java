...
public class UnixEpochTimestampGenerator extends Generator<Long> {
     ...
     * @param interval The interval for incrementing the timestamp.
     * @param timeUnits The units of time the increment represents.
     * @param startTimestamp The start timestamp to use. NOTE that this must match the time units used for the interval. If the units are in nanoseconds, provide a nanosecond timestamp {@code System.nanoTime()} or in microseconds, {@code System.nanoTime() / 1000} or in millis, {@code
     * System.currentTimeMillis()} or seconds and any interval above, {@code System.currentTimeMillis() / 1000}
     */
    public UnixEpochTimestampGenerator( final long interval, final TimeUnit timeUnits,
