 ...
 *
 * This package contains a collection of database-specific overrides. This accounts for the variance that can be present where JDBC does not explicitly define what a database must do or when a database has a non-standard SQL implementation.
 *
 * This package contains a collection of database-specific overrides. This accounts for the variance that can be present where JDBC does not explicitly define what a database must do or when a database has a non-standard SQL implementation.
 *
 * This package contains a collection of database-specific overrides. This accounts for the variance that can be present where JDBC does not explicitly define what a database must do or when a database has a non-standard SQL implementation.
