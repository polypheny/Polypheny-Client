...
public class Measurements {
    ...
    public Measurements( Properties props ) {
        ...
        String mTypeString = this.props
                .getProperty( MEASUREMENT_TYPE_PROPERTY, MEASUREMENT_TYPE_PROPERTY_DEFAULT );
        switch ( mTypeString ) {
            case "histogram":
        ...
        String mIntervalString = this.props
                .getProperty( MEASUREMENT_INTERVAL, MEASUREMENT_INTERVAL_DEFAULT );
