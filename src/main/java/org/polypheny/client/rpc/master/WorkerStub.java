package org.polypheny.client.rpc.master;
...
import org.polypheny.client.grpc.ClientWorkerGrpc;
import org.polypheny.client.grpc.ClientWorkerGrpc.ClientWorkerStub;
...
public class WorkerStub {
    ...
    /**
     * RPC Call to launch a {@link Worker}
     *
     ...
     * Write all results to a streamwriter
     *
     * @param writer each {@link org.polypheny.client.grpc.PolyClientGRPC.MUSQLEResultTuple} will be written to this writer
     */
    ...
    public void writeWorkerMonitorResult( StreamWriter<NetdataMeasurement> writer, String host, long start, long stop ) {
        FetchMonitorWorkerMessage workerMessage = ProtoObjectFactory.FetchMonitorWorkerMessage( host, start, stop );
    ...
    public void launchDBMonitor( PolyphenyJobCdl job ) {
        MonitorWorkerMessage workerMessage = ProtoObjectFactory.createMonitorWorkerMessage( job.getEvaluation().getDbms().getHost(), job.getEvaluation().getOptions().getMeasurementOptions() );
