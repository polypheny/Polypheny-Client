 ...
 */
public class PolyphenyDbDeliveryTransactionExecutor extends DeliveryTransactionExecutor {

    private static final Logger logger = LogManager.getLogger();
    private DBConnector connector;


    public PolyphenyDbDeliveryTransactionExecutor( DBConnector connector ) {
        super( connector );
    ...
    protected void commitIndividualTrx() {
        logger.trace( "polypheny only does the toplevel transaction" );
    }
