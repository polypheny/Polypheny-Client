...
package org.polypheny.client.generator.tpch.objects;
...
public final class GenerateUtils {
    ...
    public static long calculateRowCount( int scaleBase, double scaleFactor, int part,
            int partCount ) {
    ...
    public static long calculateStartIndex( int scaleBase, double scaleFactor, int part,
            int partCount ) {
        long totalRowCount = (long) (scaleBase * scaleFactor);
