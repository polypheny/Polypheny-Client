...
import static org.polypheny.client.generator.tpch.TPCHPopulationGenerators.DistributionLoader.loadDistribution;
...
public class Distributions {
    ...
    public static synchronized Distributions getDefaultDistributions() {
        if ( DEFAULT_DISTRIBUTIONS == null ) {
            try {
                URL resource = Resources.getResource( Distribution.class, "/tpch/population/dists.dss" );
