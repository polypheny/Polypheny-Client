...
public abstract class AbstractRandomInt {
    ...
    /**
     * Creates a new random number generator with the specified seed and specified number of random values per row.
     */
    ...
    /**
     * Advances the random number generator to the start of the sequence for the next row.  Each row uses a specified number of random values, so the random number generator can be quickly advanced for partitioned data sets.
     */
    ...
    /**
     * Advance the specified number of rows.  Advancing to a specific row is needed for partitioned data sets.
     */
